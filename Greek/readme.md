...
[![εγκατάσταση στα Windows](../images/installing_on_windows.png)](https://www.python.org/)

Αν χρησιμοποιείς macOS, πάτησε το κουμπί που είναι κυκλωμένο με κόκκινο.

[![εγκατάσταση στο macOS](../images/installing_on_macOS.png)](https://www.python.org/)
